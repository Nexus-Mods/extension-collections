  ...
  return (
    <div ref={container} id='collection-file-overrides' className='collection-file-overrides'>
      <ControlLabel>
        ...
        <p>
          {t('Please note that these pre-generated file overrides are toggled off by default, as any 1.10.X Vortex client will '
           + 'generate them on the client machine as part of the collection installation automatically. Therefore there\'s no '
           + 'explicit need to export these overrides; '
           + 'unless you have manually set certain overrides which are not generated by the mod dependency system.')}
        </p>
        <p>
          {t('Any mod entries in this page, highlight a set of game files which will NOT be deployed on the user\'s machine by the specified mod entry.'
